...
from GameAI.game import State
from GameAI.pv_mcts import pv_mcts_action
from GameAI.game import random_action,mcs_action
...
@app.route("/game/alphazero")
def game_alphazero():
    return next("/game/alphazero",alphazero)
